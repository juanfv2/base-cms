...
Route::middleware(['auth:sanctum', 'role', 'sentry.context'])->group(function () {
    ...
    Route::get('tracking-jobs/downloadable/{id}', [App\Http\Controllers\API\Misc\TrackingJobAPIController::class, 'downloadable'])->name('tracking-jobs.downloadable');
    ...
    Route::apiResource('tracking-jobs', \App\Http\Controllers\API\Misc\TrackingJobAPIController::class);
    Route::apiResource('item-fields', App\Http\Controllers\API\Misc\ItemFieldAPIController::class);
